...
- ✅ Predicts the percentage of text content written by AI (wip for improvement)
...
### Advanced Optimization for MacBook Apple Silicon Devices
...
Please note that the results generated by CheckGPT are based on an AI model and may not be 100% accurate. It is advisable to use these results for investigation purposes and exercise caution when making decisions based on the analysis.
The code for this project is released under the MIT License, which means you are free to use it as you see fit. However, please note that there is no warranty or guarantee provided with the code, and the developers are not liable for any issues or consequences arising from its use.
